...
3. Install MongoDB on the machine you are running the CSS, by running one of the following:
...
If you are no longer running your CSS on the same host as your MongoDB, you need to update the *MongoAddressCsv* property in the css-http.conf configuration file, to have a value <host>:<port>, where <host> is the host
